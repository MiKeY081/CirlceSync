...
const Header = () => {
  ...
  return (
    <nav className='flex items-center justify-between px-4 py-2 bg-gray-800 text-white relative'>
      ...
      <div className='flex items-center flex-grow justify-center md:justify-start gap-2'>
        <input
          id='search'
          type='text'
          placeholder='Search'
